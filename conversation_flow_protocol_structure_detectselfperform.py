...
while True:
    if skip_key == 0:
        ...
        6) Respond ONLY with the matched condition exactly as listed above.
        """
    ...
    if matched and matched["next_step"].lower() != "remain" and matched["next_step"].lower() != "step remain":
        if matched["next_step"].lower() == "step proceed to previous step":
            ...
            steps_string =f"Please key in the NUMBER of following step which you would like to revisit:\n\n List of Previous Steps:\n{steps_string}"
            print(steps_string)
            user_input = input("User: ")
